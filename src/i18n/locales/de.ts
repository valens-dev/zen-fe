export const de = {
  material: {
    ...
    materialForm: {
      ...
      customTariffPlaceholder: 'Zolltarifnummer eingeben',
  ...
  station: {
    ...
    stationLoginForm: {
      ...
      submitButton: 'Weiter',
      usernameRequired: 'Das Feld Benutzername ist erforderlich!',
      passwordRequired: 'Das Feld Passwort ist erforderlich!',
      passwordPattern: 'Das Passwort ist ungültig.',
    },
  },
  home: {
    title: 'Startseite',
